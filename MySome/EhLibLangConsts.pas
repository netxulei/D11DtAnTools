...
begin
  ...
  CustomizeColumnsDialog := '自定义显示列 ...';

  DBGridEhCustomizeColumnsDialog_VisibleColumns := '可见列';
  DBGridEhCustomizeColumnsDialog_HiddenColumns := '隐藏列';
  DBGridEhCustomizeColumnsDialog_Caption := '字段设置';
  DBGridEhCustomizeColumnsDialog_ColumnName := '列名';
  DBGridEhCustomizeColumnsDialog_ColumnWidth := '列宽度';
  DBGridEhCustomizeColumnsDialog_SetWidth_Hint := '设置宽度';
  DBGridEhCustomizeColumnsDialog_MoveUp_Hint := '上移';
  DBGridEhCustomizeColumnsDialog_MoveDown_Hint := '下移';
  DBGridEhCustomizeColumnsDialog_Hide_Hint := '隐藏';
  DBGridEhCustomizeColumnsDialog_Show_Hint := '显示';
  DBGridEhCustomizeColumnsDialog_EnterNumericalValue := '输入数值型数字';
  DBGridEhCustomizeColumnsDialog_EnterColumnWidthS := '列宽';
